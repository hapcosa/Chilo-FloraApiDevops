...
constexpr const char* kSelectCols =
    ...
    "categoria_moderacion_id, creado_por, revisado_por, "
...
Especie PostgreSQLEspecieRepository::mapRowToEspecie(const pqxx::row& row) {
    ...
    e.setCategoriaModeracionId(optInt(row["categoria_moderacion_id"]));
...
EspecieSearchResult PostgreSQLEspecieRepository::find(
    ...
    try {
        ...
        dataSql +=
            ...
            "e.categoria_moderacion_id, e.creado_por, e.revisado_por, e.fecha_revision, "
    ...
    try {
        ...
        pqxx::result result = txn.exec_params(
            std::string("INSERT INTO especies (")
                ...
                + "categoria_moderacion_id, creado_por, revisado_por, fecha_revision"
                + ") VALUES ("
            ...
            especie.getCategoriaModeracionId(),
    ...
    try {
        ...
        pqxx::result result = txn.exec_params(
            std::string("UPDATE especies SET ")
                ...
                + "categoria_moderacion_id = $17, creado_por = $18, revisado_por = $19, "
                + "fecha_revision = $20 "
